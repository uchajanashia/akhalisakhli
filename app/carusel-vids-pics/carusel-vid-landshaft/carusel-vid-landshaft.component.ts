...
@Component({
    selector: 'app-carusel-vid-landshaft',
    standalone: true,
    templateUrl: './carusel-vid-landshaft.component.html',
    styleUrl: './carusel-vid-landshaft.component.scss',
    imports: [CommonModule, VidsliderComponent]
})
export class CaruselVidLandshaftComponent {
